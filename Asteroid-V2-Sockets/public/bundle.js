...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Polygon__ = __webpack_require__(5);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_socket_io_client__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_socket_io_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_socket_io_client__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__GameState__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__canvas__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__references_gameStates__ = __webpack_require__(297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Asteroid__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Ship__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__InputHandeler__ = __webpack_require__(298);
...
class Game {
  constructor() {
    this.canvas = new __WEBPACK_IMPORTED_MODULE_2__canvas__["a" /* default */](640, 480);
    ...
    this.state = {
      currentState: null,
      nextState: __WEBPACK_IMPORTED_MODULE_3__references_gameStates__["a" /* default */].GAME
    };
    socket.on('newState', (state) => {
      this.state = JSON.parse(state);
      // console.log(this.state);
      this.state.currentState = Object.setPrototypeOf(this.state.currentState, __WEBPACK_IMPORTED_MODULE_1__GameState__["a" /* default */].prototype);
      this.state.currentState.asteroids.map(asteroid => Object.setPrototypeOf(asteroid, __WEBPACK_IMPORTED_MODULE_4__Asteroid__["a" /* default */].prototype));
      this.state.currentState.ship = Object.setPrototypeOf(this.state.currentState.ship, __WEBPACK_IMPORTED_MODULE_5__Ship__["a" /* default */].prototype);
    });
  }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(50)(module), __webpack_require__(14)))
...
var hasCORS = __webpack_require__(289);
...
var JSONP = __webpack_require__(291);
var websocket = __webpack_require__(292);
...
var parseqs = __webpack_require__(271);
var parser = __webpack_require__(44);
var inherit = __webpack_require__(272);
var yeast = __webpack_require__(279);
...
var parser = __webpack_require__(47);
var Manager = __webpack_require__(276);
...
exports.Manager = __webpack_require__(276);
...
var parser = __webpack_require__(44);
var parseuri = __webpack_require__(275);
var parsejson = __webpack_require__(294);
var parseqs = __webpack_require__(271);
...
var XMLHttpRequest = __webpack_require__(273);
var Polling = __webpack_require__(278);
var Emitter = __webpack_require__(264);
var inherit = __webpack_require__(272);
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(293);
  } catch (e) { }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Ship__ = __webpack_require__(10);
...
var sliceBuffer = __webpack_require__(216);
var after = __webpack_require__(217);
var utf8 = __webpack_require__(218);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(219);
}
...
var Blob = __webpack_require__(220);
